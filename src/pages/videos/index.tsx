          ...
          <TableContainer>
            <Table variant="simple">
              <Thead>
                <Tr>
                  <Th>file_path</Th>
                  {hasAccess('text_document', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && (
                    <Th>text_document</Th>
                  )}
              ...
              <Tbody>
                {data?.map((record) => (
                  <Tr cursor="pointer" onClick={() => handleView(record.id)} key={record.id}>
                    ...
                    {hasAccess('text_document', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && (
                      <Td>
                        <Link as={NextLink} href={`/text-documents/view/${record.text_document?.id}`}>
                          {record.text_document?.content}
                        </Link>
                      </Td>
                    )}
